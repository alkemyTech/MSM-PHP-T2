...
class LogiIntTest extends TestCase
{
    ...
    public function test_log_in_returns_token_and_user(): void
    {
        ...
        $response
            ...
            ->assertJsonPath('datos.user.email', $logData['email'])
            ->assertJsonStructure(['datos' => ['token', 'user']]);
    ...
    public function test_log_in_with_invalid_password(): void
    {
        ...
        $response
            ->assertStatus(401)
            ->assertJsonPath('mensaje', 'Usuario no autorizado.');
    }
